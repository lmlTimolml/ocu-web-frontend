  ...
  return (
    ...
    <div className="mx-5 md:mx-10 lg:m-auto grid grid-cols-3 md:grid-cols-6 lg:grid-cols-12 gap-4 max-w-[1440px]"> 
      <div className="col-span-3 md:col-span-6 lg:col-span-8 lg:col-start-3">
        ...
        { content && <div className="font-medium text-lg sm:text-2xl mb-5"><ReactMarkdown>{content}</ReactMarkdown></div> }
    </div>
      { button && <div className="col-span-3 md:col-span-6 lg:col-start-3 lg:col-span-8 grid grid-cols-2 sm:grid-cols-4 gap-4">
          {button?.map((btn, i) => {
