...
import { getServicesThree, getGlobalContent } from "../../lib/api";
...
export async function getStaticProps() {
  const pageContent = await getServicesThree(); // fetches query
  const globalContent = await getGlobalContent();

  return {
    props: {
      pageContent: pageContent.serviceSubPageThree.data.attributes, // creates a const from toplevel query and serves it as prop
