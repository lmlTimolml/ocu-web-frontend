...
export default function Outline({ label, link, txt, style }) {
  return (
    <Link
      href={link}
      className="group/btn flex items-center box-border rounded-[0.25rem] px-6 py-2 border border-black bg-transparent antialiased ease-linear duration-300 relative h-max w-max"
    >
